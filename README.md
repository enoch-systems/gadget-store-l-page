# Gadget Store - Premium Tech E-commerce
...
### Core Functionality
- Dynamic product catalog with category filtering (Smartphones, Audio, Gaming, Laptops)
...
Repository: [https://github.com/enoch-systems/gadget-store](https://github.com/enoch-systems/gadget-store)

```bash
# Clone the repository
git clone https://github.com/enoch-systems/gadget-store.git
cd gadget-store
